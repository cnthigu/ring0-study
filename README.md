# ring0-study (cpp-cnt-study)

Aqui fica o meu registro de estudo em **C++** em geral.

Fique a vontade para usar como referencia; sugestoes sao bem-vindas (por exemplo numa issue).

**Nota:** nao ha promessa de cobertura total de nada.

---

| Pasta | O que e |
| --- | --- |
| [`livros/`](./livros/) | Livros tecnicos |
| [`codes/`](./codes/) | Referencia rapida de codigo (C++ e exemplos) |
